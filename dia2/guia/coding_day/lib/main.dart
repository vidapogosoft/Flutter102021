...
import 'package:coding_day/data/databasehelper.dart';
import 'package:coding_day/model/todo.dart';
import 'package:coding_day/pages/mapas.dart';
import 'package:coding_day/pages/fotos.dart';
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    Expanded(
                        child: TextFormField(
                      decoration: InputDecoration(hintText: "Ingrese una trea"),
                      controller: textController,
                    )),
                    IconButton(icon: Icon(Icons.add), onPressed: _addToDb)
                  ],
                ),
                SizedBox(height: 20),
                Expanded(
